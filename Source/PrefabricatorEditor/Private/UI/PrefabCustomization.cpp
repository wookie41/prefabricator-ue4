...
void FPrefabActorCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
    ...
    for (APrefabActor* PrefabActor : PrefabActors)
    {
        if (PrefabActor->PrefabComponent)
        {
            ...
            UPrefabricatorAssetInterface* Asset =
              PrefabActor->PrefabComponent->PrefabAssetInterface.LoadSynchronous();
    ...
    FPrefabDetailsExtend& ExtenderDelegate =
      IPrefabricatorEditorModule::Get().GetPrefabActorDetailsExtender();
    ...
    if (!bIsCollection)
    {
        IDetailCategoryBuilder& Category =
          DetailBuilder.EditCategory("Prefab Asset Actions", FText::GetEmpty(), ECategoryPriority::Important);
        Category.AddExternalObjectProperty(PrefabComponents,
                                           GET_MEMBER_NAME_CHECKED(UPrefabComponent, PrefabAssetInterface));
                               ...
                               .FillWidth(1.0f)
                                 ...
                                 [SNew(SButton)
                                    ...
                                    .OnClicked(FOnClicked::CreateStatic(
                                      &FPrefabActorCustomization::HandleSaveToAsset, &DetailBuilder))] +
                             SHorizontalBox::Slot()
                               .VAlign(VAlign_Center)
                               .FillWidth(1.0f)
                                 //.Padding(4.0f)
                                 [SNew(SButton)
                                    ...
                                    .OnClicked(FOnClicked::CreateStatic(
                                      &FPrefabActorCustomization::HandleSaveToNewAsset, &DetailBuilder))] +
                             SHorizontalBox::Slot()
                               .VAlign(VAlign_Center)
                               .FillWidth(1.0f)
                                 //.Padding(4.0f)
                                 [SNew(SButton)
                                    ...
                                    .OnClicked(FOnClicked::CreateStatic(
                                      &FPrefabActorCustomization::HandleLoadFromAsset, &DetailBuilder))]
        ...
        Category.AddCustomRow(LOCTEXT("PrefabCommandRandomize_Filter", "randomize prefab collection asset"))
          .WholeRowContent()[SNew(SButton)
                               ...
                               .OnClicked(FOnClicked::CreateStatic(
                                 &FPrefabActorCustomization::RandomizePrefabCollection, &DetailBuilder))];

        Category.AddCustomRow(LOCTEXT("PrefabCommandUnlink_Filter", "unlink prefab"))
          .WholeRowContent()[SNew(SButton)
                               .Text(LOCTEXT("PrefabCommand_Unlink", "Unlink"))
                               .OnClicked(FOnClicked::CreateStatic(&FPrefabActorCustomization::UnlinkPrefab,
                                                                   &DetailBuilder))];
    ...
    else
    {
        IDetailCategoryBuilder& Category = DetailBuilder.EditCategory(
          "Prefab Collection Actions", FText::GetEmpty(), ECategoryPriority::Important);
        Category.AddExternalObjectProperty(PrefabComponents,
                                           GET_MEMBER_NAME_CHECKED(UPrefabComponent, PrefabAssetInterface));
        ...
        Category
          .AddCustomRow(
            LOCTEXT("PrefabCollectionCommandRandomize_Filter", "randomize prefab collection asset"))
          .WholeRowContent()[SNew(SButton)
...
{
    IDetailCategoryBuilder& Category =
      DetailBuilder.EditCategory("Prefab Randomizer", FText::GetEmpty(), ECategoryPriority::Important);
    Category.AddCustomRow(LOCTEXT("PrefabRandomizerCommand_Filter", "randomize prefab collection asset"))
      .WholeRowContent()[SNew(SButton)
                           ...
                           .OnClicked(FOnClicked::CreateStatic(
                             &FPrefabRandomizerCustomization::HandleRandomize, &DetailBuilder))];
}
...
void FPrefabricatorAssetCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
    ...
    IDetailCategoryBuilder& Category =
      DetailBuilder.EditCategory("Thumbnail", FText::GetEmpty(), ECategoryPriority::Uncommon);
...
{
    IDetailCategoryBuilder& Category =
      DetailBuilder.EditCategory("Prefab Debug", FText::GetEmpty(), ECategoryPriority::Important);
    Category.AddCustomRow(LOCTEXT("PrefabDebugCommand_SaveFilter", "save debug prefab"))
      .WholeRowContent()[SNew(SButton)
                           ...
                           .OnClicked(FOnClicked::CreateStatic(&FPrefabDebugCustomization::SaveDebugData,
                                                               &DetailBuilder))];
    ...
    Category.AddCustomRow(LOCTEXT("PrefabDebugCommand_LoadFilter", "load debug prefab"))
      .WholeRowContent()[SNew(SButton)
                           ...
                           .OnClicked(FOnClicked::CreateStatic(&FPrefabDebugCustomization::LoadDebugData,
                                                               &DetailBuilder))];
}
